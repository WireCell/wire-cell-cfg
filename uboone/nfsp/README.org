...
#+BEGIN_EXAMPLE
  ...
  $ cp ubnfsp.json.bz2 wire-cell-cfg/uboone/nfsp/*.fcl /path/to/rundir
...
#+BEGIN_EXAMPLE
  # pre hardware noise fix input data:
  $ art -c ubnfspct-prehwf.fcl -o output.root -s input.root
  # post hardware noise fix input data:
  $ art -c ubnfspct-posthwf.fcl -o output.root -s input.root
#+END_EXAMPLE
